define(
	...
	{	
		var Authorize = {
			...
			{
				$("#login").html(Mustache.render (Templates.login, config));
				
				// $("iframe").get(0).src =
				// config.authurl + "login?response_type=token&state=xyz&client_id=" + config.appid + "&redirect_uri=" + origin() + "/auth.html";
			},
